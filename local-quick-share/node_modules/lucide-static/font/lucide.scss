@font-face {
  font-family: "lucide";
  src: url('lucide.eot?t=1774371383468'); /* IE9*/
  src: url('lucide.eot?t=1774371383468#iefix') format('embedded-opentype') /* IE6-IE8 */,
  url('lucide.woff2?t=1774371383468') format('woff2'),
  url('lucide.woff?t=1774371383468') format('woff'),
  url('lucide.ttf?t=1774371383468') format('truetype'),
  url('lucide.svg?t=1774371383468') format('svg');
}
...
.icon-shield-cog-corner::before { content: "\e6da"; }
.icon-shield-cog::before { content: "\e6da"; }
...
$icon-a-arrow-down: '\e585';
$icon-a-arrow-up: '\e586';
$icon-a-large-small: '\e587';
$icon-accessibility: '\e297';
$icon-activity-square: '\e4b4';
$icon-activity: '\e038';
$icon-air-vent: '\e34d';
$icon-airplay: '\e039';
$icon-alarm-check: '\e1ec';
...
$icon-alarm-minus: '\e1ed';
$icon-alarm-plus: '\e1ee';
$icon-alarm-smoke: '\e57b';
$icon-album: '\e03b';
$icon-alert-circle: '\e077';
$icon-alert-octagon: '\e127';
$icon-alert-triangle: '\e193';
$icon-align-center-horizontal: '\e26c';
$icon-align-center-vertical: '\e26d';
$icon-align-center: '\e182';
$icon-align-end-horizontal: '\e26e';
$icon-align-end-vertical: '\e26f';
$icon-align-horizontal-distribute-center: '\e03c';
$icon-align-horizontal-distribute-end: '\e03d';
$icon-align-horizontal-distribute-start: '\e03e';
...
$icon-align-justify: '\e184';
$icon-align-left: '\e185';
$icon-align-right: '\e183';
...
$icon-anvil: '\e580';
$icon-aperture: '\e040';
$icon-app-window-mac: '\e5d2';
$icon-app-window: '\e426';
$icon-apple: '\e34e';
$icon-archive-restore: '\e2cd';
$icon-archive-x: '\e50c';
$icon-archive: '\e041';
$icon-area-chart: '\e4d3';
$icon-armchair: '\e2c0';
$icon-arrow-big-down-dash: '\e41d';
$icon-arrow-big-down: '\e1e1';
$icon-arrow-big-left-dash: '\e41e';
$icon-arrow-big-left: '\e1e2';
$icon-arrow-big-right-dash: '\e41f';
$icon-arrow-big-right: '\e1e3';
$icon-arrow-big-up-dash: '\e420';
$icon-arrow-big-up: '\e1e4';
$icon-arrow-down-0-1: '\e413';
$icon-arrow-down-01: '\e413';
$icon-arrow-down-1-0: '\e414';
$icon-arrow-down-10: '\e414';
$icon-arrow-down-a-z: '\e415';
$icon-arrow-down-az: '\e415';
$icon-arrow-down-circle: '\e078';
$icon-arrow-down-from-line: '\e454';
$icon-arrow-down-left-from-circle: '\e3f7';
$icon-arrow-down-left-from-square: '\e5a1';
$icon-arrow-down-left-square: '\e4b5';
$icon-arrow-down-left: '\e043';
$icon-arrow-down-narrow-wide: '\e044';
$icon-arrow-down-right-from-circle: '\e3f8';
$icon-arrow-down-right-from-square: '\e5a2';
$icon-arrow-down-right-square: '\e4b6';
$icon-arrow-down-right: '\e045';
$icon-arrow-down-square: '\e427';
$icon-arrow-down-to-dot: '\e44d';
$icon-arrow-down-to-line: '\e455';
$icon-arrow-down-up: '\e046';
$icon-arrow-down-wide-narrow: '\e047';
$icon-arrow-down-z-a: '\e416';
$icon-arrow-down-za: '\e416';
$icon-arrow-down: '\e042';
$icon-arrow-left-circle: '\e079';
$icon-arrow-left-from-line: '\e456';
$icon-arrow-left-right: '\e24a';
$icon-arrow-left-square: '\e428';
$icon-arrow-left-to-line: '\e457';
$icon-arrow-left: '\e048';
$icon-arrow-right-circle: '\e07a';
$icon-arrow-right-from-line: '\e458';
$icon-arrow-right-left: '\e417';
$icon-arrow-right-square: '\e429';
$icon-arrow-right-to-line: '\e459';
$icon-arrow-right: '\e049';
$icon-arrow-up-0-1: '\e418';
$icon-arrow-up-01: '\e418';
$icon-arrow-up-1-0: '\e419';
$icon-arrow-up-10: '\e419';
$icon-arrow-up-a-z: '\e41a';
$icon-arrow-up-az: '\e41a';
$icon-arrow-up-circle: '\e07b';
$icon-arrow-up-down: '\e37d';
$icon-arrow-up-from-dot: '\e44e';
$icon-arrow-up-from-line: '\e45a';
$icon-arrow-up-left-from-circle: '\e3f9';
$icon-arrow-up-left-from-square: '\e5a3';
$icon-arrow-up-left-square: '\e4b7';
$icon-arrow-up-left: '\e04b';
$icon-arrow-up-narrow-wide: '\e04c';
$icon-arrow-up-right-from-circle: '\e3fa';
$icon-arrow-up-right-from-square: '\e5a4';
$icon-arrow-up-right-square: '\e4b8';
$icon-arrow-up-right: '\e04d';
$icon-arrow-up-square: '\e42a';
$icon-arrow-up-to-line: '\e45b';
$icon-arrow-up-wide-narrow: '\e41b';
$icon-arrow-up-z-a: '\e41c';
$icon-arrow-up-za: '\e41c';
$icon-arrow-up: '\e04a';
$icon-arrows-up-from-line: '\e4d4';
$icon-asterisk-square: '\e168';
$icon-asterisk: '\e1ef';
$icon-at-sign: '\e04e';
$icon-atom: '\e3d7';
$icon-audio-lines: '\e55a';
$icon-audio-waveform: '\e55b';
$icon-award: '\e04f';
$icon-axe: '\e050';
$icon-axis-3-d: '\e2fe';
$icon-axis-3d: '\e2fe';
$icon-baby: '\e2ce';
$icon-backpack: '\e2c8';
$icon-badge-alert: '\e475';
$icon-badge-cent: '\e50f';
$icon-badge-check: '\e241';
$icon-badge-dollar-sign: '\e476';
$icon-badge-euro: '\e510';
$icon-badge-help: '\e47b';
$icon-badge-indian-rupee: '\e511';
$icon-badge-info: '\e477';
$icon-badge-japanese-yen: '\e512';
$icon-badge-minus: '\e478';
$icon-badge-percent: '\e479';
$icon-badge-plus: '\e47a';
$icon-badge-pound-sterling: '\e513';
$icon-badge-question-mark: '\e47b';
$icon-badge-russian-ruble: '\e514';
$icon-badge-swiss-franc: '\e515';
$icon-badge-turkish-lira: '\e67e';
$icon-badge-x: '\e47c';
$icon-badge: '\e474';
...
$icon-banana: '\e34f';
$icon-bandage: '\e61d';
$icon-banknote-arrow-down: '\e64c';
$icon-banknote-arrow-up: '\e64d';
$icon-banknote-x: '\e64e';
$icon-banknote: '\e052';
$icon-bar-chart-2: '\e068';
$icon-bar-chart-3: '\e2a3';
$icon-bar-chart-4: '\e2a4';
$icon-bar-chart-big: '\e4a9';
$icon-bar-chart-horizontal-big: '\e4a7';
$icon-bar-chart-horizontal: '\e2a2';
$icon-bar-chart: '\e06a';
$icon-barcode: '\e533';
$icon-barrel: '\e675';
$icon-baseline: '\e285';
$icon-bath: '\e2ab';
$icon-battery-charging: '\e054';
$icon-battery-full: '\e055';
$icon-battery-low: '\e056';
$icon-battery-medium: '\e057';
$icon-battery-plus: '\e63e';
$icon-battery-warning: '\e3ac';
$icon-battery: '\e053';
$icon-beaker: '\e058';
$icon-bean-off: '\e390';
$icon-bean: '\e38f';
...
$icon-beer: '\e2cf';
$icon-bell-dot: '\e42b';
$icon-bell-electric: '\e57c';
$icon-bell-minus: '\e1f0';
$icon-bell-off: '\e05a';
$icon-bell-plus: '\e1f1';
$icon-bell-ring: '\e224';
$icon-bell: '\e059';
$icon-between-horizonal-end: '\e591';
$icon-between-horizonal-start: '\e592';
$icon-between-horizontal-end: '\e591';
$icon-between-horizontal-start: '\e592';
$icon-between-vertical-end: '\e593';
$icon-between-vertical-start: '\e594';
$icon-biceps-flexed: '\e5eb';
$icon-bike: '\e1d2';
$icon-binary: '\e1f2';
$icon-binoculars: '\e621';
$icon-biohazard: '\e441';
$icon-bird: '\e3c5';
$icon-birdhouse: '\e69a';
$icon-bitcoin: '\e05b';
...
$icon-bone: '\e358';
$icon-book-a: '\e544';
$icon-book-alert: '\e672';
$icon-book-audio: '\e545';
$icon-book-check: '\e546';
$icon-book-copy: '\e3ec';
$icon-book-dashed: '\e3ed';
$icon-book-down: '\e3ee';
$icon-book-headphones: '\e547';
$icon-book-heart: '\e548';
$icon-book-image: '\e549';
$icon-book-key: '\e3ef';
$icon-book-lock: '\e3f0';
$icon-book-marked: '\e3f1';
$icon-book-minus: '\e3f2';
$icon-book-open-check: '\e381';
$icon-book-open-text: '\e54a';
$icon-book-open: '\e05f';
$icon-book-plus: '\e3f3';
$icon-book-search: '\e6ab';
$icon-book-template: '\e3ed';
$icon-book-text: '\e54b';
$icon-book-type: '\e54c';
$icon-book-up-2: '\e4a6';
$icon-book-up: '\e3f4';
...
$icon-book-x: '\e3f5';
$icon-book: '\e05e';
$icon-bookmark-check: '\e51f';
$icon-bookmark-minus: '\e23c';
$icon-bookmark-plus: '\e23d';
$icon-bookmark-x: '\e520';
$icon-bookmark: '\e060';
$icon-boom-box: '\e4ee';
$icon-bot-message-square: '\e5ce';
$icon-bot-off: '\e5e0';
$icon-bot: '\e1bb';
$icon-bottle-wine: '\e67b';
$icon-bow-arrow: '\e65e';
$icon-box-select: '\e1cb';
$icon-box: '\e061';
$icon-boxes: '\e2d0';
$icon-braces: '\e36a';
$icon-brackets: '\e443';
$icon-brain-circuit: '\e3c7';
$icon-brain-cog: '\e3c8';
$icon-brain: '\e3c6';
$icon-brick-wall-fire: '\e653';
$icon-brick-wall-shield: '\e690';
$icon-brick-wall: '\e581';
$icon-briefcase-business: '\e5d5';
$icon-briefcase-conveyor-belt: '\e62b';
$icon-briefcase-medical: '\e5d6';
$icon-briefcase: '\e062';
$icon-bring-to-front: '\e4ef';
$icon-brush-cleaning: '\e666';
$icon-brush: '\e1d3';
$icon-bubbles: '\e654';
$icon-bug-off: '\e50d';
$icon-bug-play: '\e50e';
...
$icon-cable-car: '\e4fc';
$icon-cable: '\e4e3';
$icon-cake-slice: '\e4b9';
$icon-cake: '\e344';
$icon-calculator: '\e1bc';
$icon-calendar-1: '\e630';
$icon-calendar-arrow-down: '\e5fe';
$icon-calendar-arrow-up: '\e5ff';
$icon-calendar-check-2: '\e2b8';
$icon-calendar-check: '\e2b7';
$icon-calendar-clock: '\e304';
$icon-calendar-cog: '\e5ed';
$icon-calendar-days: '\e2b9';
$icon-calendar-fold: '\e5b4';
$icon-calendar-heart: '\e305';
$icon-calendar-minus-2: '\e5b5';
$icon-calendar-minus: '\e2ba';
$icon-calendar-off: '\e2bb';
$icon-calendar-plus-2: '\e5b6';
$icon-calendar-plus: '\e2bc';
$icon-calendar-range: '\e2bd';
$icon-calendar-search: '\e306';
$icon-calendar-sync: '\e636';
$icon-calendar-x-2: '\e2bf';
$icon-calendar-x: '\e2be';
$icon-calendar: '\e063';
$icon-calendars: '\e6a7';
$icon-camera-off: '\e065';
$icon-camera: '\e064';
$icon-candlestick-chart: '\e4a8';
$icon-candy-cane: '\e4ba';
$icon-candy-off: '\e392';
$icon-candy: '\e391';
$icon-cannabis-off: '\e6af';
$icon-cannabis: '\e5d4';
$icon-captions-off: '\e5c1';
$icon-captions: '\e3a4';
$icon-car-front: '\e4fd';
$icon-car-taxi-front: '\e4fe';
$icon-car: '\e1d5';
$icon-caravan: '\e539';
$icon-card-sim: '\e671';
$icon-carrot: '\e25a';
$icon-case-lower: '\e3d8';
$icon-case-sensitive: '\e3d9';
$icon-case-upper: '\e3da';
$icon-cassette-tape: '\e4ca';
$icon-cast: '\e066';
$icon-castle: '\e3e0';
$icon-cat: '\e38c';
$icon-cctv-off: '\e6d8';
$icon-cctv: '\e57d';
$icon-chart-area: '\e4d3';
$icon-chart-bar-big: '\e4a7';
$icon-chart-bar-decreasing: '\e607';
$icon-chart-bar-increasing: '\e608';
$icon-chart-bar-stacked: '\e609';
$icon-chart-bar: '\e2a2';
$icon-chart-candlestick: '\e4a8';
$icon-chart-column-big: '\e4a9';
$icon-chart-column-decreasing: '\e067';
$icon-chart-column-increasing: '\e2a4';
$icon-chart-column-stacked: '\e60a';
$icon-chart-column: '\e2a3';
$icon-chart-gantt: '\e624';
$icon-chart-line: '\e2a5';
$icon-chart-network: '\e60b';
$icon-chart-no-axes-column-decreasing: '\e069';
$icon-chart-no-axes-column-increasing: '\e06a';
$icon-chart-no-axes-column: '\e068';
$icon-chart-no-axes-combined: '\e60c';
$icon-chart-no-axes-gantt: '\e4c4';
$icon-chart-pie: '\e06b';
$icon-chart-scatter: '\e48a';
$icon-chart-spline: '\e60d';
$icon-check-check: '\e38e';
$icon-check-circle-2: '\e226';
$icon-check-circle: '\e07c';
$icon-check-line: '\e66b';
$icon-check-square-2: '\e559';
$icon-check-square: '\e16a';
$icon-check: '\e06c';
$icon-chef-hat: '\e2ac';
$icon-cherry: '\e350';
$icon-chess-bishop: '\e6a0';
$icon-chess-king: '\e6a1';
$icon-chess-knight: '\e6a2';
$icon-chess-pawn: '\e6a3';
$icon-chess-queen: '\e6a4';
$icon-chess-rook: '\e6a5';
$icon-chevron-down-circle: '\e4dd';
$icon-chevron-down-square: '\e3cf';
$icon-chevron-down: '\e06d';
$icon-chevron-first: '\e243';
$icon-chevron-last: '\e244';
$icon-chevron-left-circle: '\e4de';
$icon-chevron-left-square: '\e3d0';
$icon-chevron-left: '\e06e';
$icon-chevron-right-circle: '\e4df';
$icon-chevron-right-square: '\e3d1';
$icon-chevron-right: '\e06f';
$icon-chevron-up-circle: '\e4e0';
$icon-chevron-up-square: '\e3d2';
$icon-chevron-up: '\e070';
$icon-chevrons-down-up: '\e228';
$icon-chevrons-down: '\e071';
$icon-chevrons-left-right-ellipsis: '\e61f';
$icon-chevrons-left-right: '\e293';
$icon-chevrons-left: '\e072';
$icon-chevrons-right-left: '\e294';
$icon-chevrons-right: '\e073';
$icon-chevrons-up-down: '\e211';
$icon-chevrons-up: '\e074';
$icon-church: '\e3e1';
$icon-cigarette-off: '\e2c7';
$icon-cigarette: '\e2c6';
$icon-circle-alert: '\e077';
$icon-circle-arrow-down: '\e078';
$icon-circle-arrow-left: '\e079';
$icon-circle-arrow-out-down-left: '\e3f7';
$icon-circle-arrow-out-down-right: '\e3f8';
$icon-circle-arrow-out-up-left: '\e3f9';
$icon-circle-arrow-out-up-right: '\e3fa';
$icon-circle-arrow-right: '\e07a';
$icon-circle-arrow-up: '\e07b';
$icon-circle-check-big: '\e07c';
$icon-circle-check: '\e226';
$icon-circle-chevron-down: '\e4dd';
$icon-circle-chevron-left: '\e4de';
$icon-circle-chevron-right: '\e4df';
$icon-circle-chevron-up: '\e4e0';
$icon-circle-dashed: '\e4b0';
$icon-circle-divide: '\e07d';
$icon-circle-dollar-sign: '\e47d';
$icon-circle-dot-dashed: '\e4b1';
$icon-circle-dot: '\e345';
$icon-circle-ellipsis: '\e346';
$icon-circle-equal: '\e400';
$icon-circle-fading-arrow-up: '\e618';
$icon-circle-fading-plus: '\e5bc';
$icon-circle-gauge: '\e4e1';
$icon-circle-help: '\e082';
$icon-circle-minus: '\e07e';
$icon-circle-off: '\e401';
$icon-circle-parking-off: '\e3ca';
$icon-circle-parking: '\e3c9';
$icon-circle-pause: '\e07f';
$icon-circle-percent: '\e51a';
$icon-circle-pile: '\e6af';
$icon-circle-play: '\e080';
$icon-circle-plus: '\e081';
$icon-circle-pound-sterling: '\e66d';
$icon-circle-power: '\e550';
$icon-circle-question-mark: '\e082';
$icon-circle-slash-2: '\e213';
$icon-circle-slash: '\e402';
$icon-circle-slashed: '\e213';
$icon-circle-small: '\e640';
$icon-circle-star: '\e68d';
$icon-circle-stop: '\e083';
$icon-circle-user-round: '\e462';
$icon-circle-user: '\e461';
$icon-circle-x: '\e084';
$icon-circle: '\e076';
$icon-circuit-board: '\e403';
$icon-citrus: '\e375';
$icon-clapperboard: '\e29b';
$icon-clipboard-check: '\e219';
$icon-clipboard-clock: '\e688';
$icon-clipboard-copy: '\e225';
$icon-clipboard-edit: '\e307';
$icon-clipboard-list: '\e086';
$icon-clipboard-minus: '\e5be';
$icon-clipboard-paste: '\e3e8';
$icon-clipboard-pen-line: '\e308';
$icon-clipboard-pen: '\e307';
$icon-clipboard-plus: '\e5bf';
$icon-clipboard-signature: '\e308';
...
$icon-clock-8: '\e255';
$icon-clock-9: '\e256';
$icon-clock-alert: '\e62a';
$icon-clock-arrow-down: '\e600';
$icon-clock-arrow-up: '\e601';
$icon-clock-check: '\e69e';
$icon-clock-fading: '\e64a';
$icon-clock-plus: '\e667';
$icon-clock: '\e087';
$icon-closed-caption: '\e68a';
$icon-cloud-alert: '\e633';
$icon-cloud-backup: '\e6af';
$icon-cloud-check: '\e66e';
$icon-cloud-cog: '\e30a';
$icon-cloud-download: '\e089';
$icon-cloud-drizzle: '\e08a';
$icon-cloud-fog: '\e214';
$icon-cloud-hail: '\e08b';
$icon-cloud-lightning: '\e08c';
$icon-cloud-moon-rain: '\e2fa';
$icon-cloud-moon: '\e215';
$icon-cloud-off: '\e08d';
$icon-cloud-rain-wind: '\e08f';
$icon-cloud-rain: '\e08e';
$icon-cloud-snow: '\e090';
$icon-cloud-sun-rain: '\e2fb';
$icon-cloud-sun: '\e216';
$icon-cloud-sync: '\e6af';
$icon-cloud-upload: '\e091';
$icon-cloud: '\e088';
$icon-cloudy: '\e217';
$icon-clover: '\e092';
$icon-club: '\e496';
$icon-code-2: '\e206';
$icon-code-square: '\e16b';
$icon-code-xml: '\e206';
$icon-code: '\e093';
$icon-coffee: '\e096';
$icon-cog: '\e30b';
$icon-coins: '\e097';
$icon-columns-2: '\e098';
$icon-columns-3-cog: '\e661';
$icon-columns-3: '\e099';
$icon-columns-4: '\e589';
$icon-columns-settings: '\e661';
$icon-columns: '\e098';
$icon-combine: '\e44c';
$icon-command: '\e09a';
$icon-compass: '\e09b';
$icon-component: '\e2ad';
$icon-computer: '\e4e4';
$icon-concierge-bell: '\e378';
$icon-cone: '\e523';
$icon-construction: '\e3b4';
$icon-contact-2: '\e463';
$icon-contact-round: '\e463';
$icon-contact: '\e09c';
$icon-container: '\e4d5';
$icon-contrast: '\e09d';
$icon-cookie: '\e26b';
$icon-cooking-pot: '\e584';
$icon-copy-check: '\e3fb';
$icon-copy-minus: '\e3fc';
$icon-copy-plus: '\e3fd';
$icon-copy-slash: '\e3fe';
$icon-copy-x: '\e3ff';
$icon-copy: '\e09e';
$icon-copyleft: '\e09f';
$icon-copyright: '\e0a0';
$icon-corner-down-left: '\e0a1';
$icon-corner-down-right: '\e0a2';
$icon-corner-left-down: '\e0a3';
$icon-corner-left-up: '\e0a4';
$icon-corner-right-down: '\e0a5';
$icon-corner-right-up: '\e0a6';
$icon-corner-up-left: '\e0a7';
$icon-corner-up-right: '\e0a8';
$icon-cpu: '\e0a9';
$icon-creative-commons: '\e3b2';
$icon-credit-card: '\e0aa';
$icon-croissant: '\e2ae';
$icon-crop: '\e0ab';
$icon-cross: '\e1e5';
$icon-crosshair: '\e0ac';
...
$icon-cuboid: '\e524';
$icon-cup-soda: '\e2d1';
$icon-curly-braces: '\e36a';
$icon-currency: '\e230';
$icon-cylinder: '\e525';
$icon-dam: '\e606';
$icon-database-backup: '\e3ab';
$icon-database-search: '\e6b1';
$icon-database-zap: '\e50b';
$icon-database: '\e0ad';
$icon-decimals-arrow-left: '\e65c';
$icon-decimals-arrow-right: '\e65d';
$icon-delete: '\e0ae';
$icon-dessert: '\e4bb';
$icon-diameter: '\e526';
$icon-diamond-minus: '\e5e1';
$icon-diamond-percent: '\e51b';
$icon-diamond-plus: '\e5e2';
$icon-diamond: '\e2d2';
$icon-dice-1: '\e287';
$icon-dice-2: '\e288';
$icon-dice-3: '\e289';
...
$icon-disc-2: '\e3f6';
$icon-disc-3: '\e494';
$icon-disc-album: '\e55c';
$icon-disc: '\e0af';
$icon-divide-circle: '\e07d';
$icon-divide-square: '\e16d';
$icon-divide: '\e0b0';
$icon-dna-off: '\e394';
$icon-dna: '\e393';
$icon-dock: '\e5d3';
$icon-dog: '\e38d';
$icon-dollar-sign: '\e0b1';
$icon-donut: '\e4bc';
$icon-door-closed-locked: '\e664';
$icon-door-closed: '\e3d5';
$icon-door-open: '\e3d6';
$icon-dot-square: '\e16e';
$icon-dot: '\e44f';
$icon-download-cloud: '\e089';
$icon-download: '\e0b2';
$icon-drafting-compass: '\e527';
$icon-drama: '\e521';
$icon-drill: '\e58d';
$icon-drone: '\e676';
$icon-droplet-off: '\e638';
$icon-droplet: '\e0b4';
$icon-droplets: '\e0b5';
$icon-drum: '\e55d';
$icon-drumstick: '\e25b';
...
$icon-egg: '\e25d';
$icon-ellipse: '\e6b2';
$icon-ellipsis-vertical: '\e0b7';
$icon-ellipsis: '\e0b6';
$icon-equal-approximately: '\e634';
$icon-equal-not: '\e1be';
$icon-equal-square: '\e16f';
$icon-equal: '\e1bd';
$icon-eraser: '\e28f';
$icon-ethernet-port: '\e620';
$icon-euro: '\e0b8';
$icon-ev-charger: '\e697';
$icon-expand: '\e21a';
$icon-external-link: '\e0b9';
$icon-eye-closed: '\e62e';
$icon-eye-off: '\e0bb';
$icon-eye: '\e0ba';
$icon-factory: '\e29f';
$icon-fan: '\e379';
$icon-fast-forward: '\e0bd';
$icon-feather: '\e0be';
$icon-fence: '\e582';
$icon-ferris-wheel: '\e47f';
$icon-file-archive: '\e30d';
$icon-file-audio-2: '\e31a';
$icon-file-audio: '\e31a';
$icon-file-axis-3-d: '\e30e';
$icon-file-axis-3d: '\e30e';
$icon-file-badge-2: '\e30f';
$icon-file-badge: '\e30f';
$icon-file-bar-chart-2: '\e311';
$icon-file-bar-chart: '\e312';
$icon-file-box: '\e310';
$icon-file-braces-corner: '\e36c';
$icon-file-braces: '\e36b';
$icon-file-chart-column-increasing: '\e312';
$icon-file-chart-column: '\e311';
$icon-file-chart-line: '\e313';
$icon-file-chart-pie: '\e314';
$icon-file-check-2: '\e0c2';
$icon-file-check-corner: '\e0c2';
$icon-file-check: '\e0c1';
$icon-file-clock: '\e315';
$icon-file-code-2: '\e45e';
$icon-file-code-corner: '\e45e';
$icon-file-code: '\e0c3';
$icon-file-cog-2: '\e316';
$icon-file-cog: '\e316';
$icon-file-diff: '\e317';
$icon-file-digit: '\e0c4';
$icon-file-down: '\e318';
$icon-file-edit: '\e31f';
$icon-file-exclamation-point: '\e319';
$icon-file-headphone: '\e31a';
$icon-file-heart: '\e31b';
$icon-file-image: '\e31c';
$icon-file-input: '\e0c5';
$icon-file-json-2: '\e36c';
$icon-file-json: '\e36b';
$icon-file-key-2: '\e31d';
$icon-file-key: '\e31d';
$icon-file-line-chart: '\e313';
$icon-file-lock-2: '\e31e';
$icon-file-lock: '\e31e';
$icon-file-minus-2: '\e0c7';
$icon-file-minus-corner: '\e0c7';
$icon-file-minus: '\e0c6';
$icon-file-music: '\e55e';
$icon-file-output: '\e0c8';
$icon-file-pen-line: '\e320';
$icon-file-pen: '\e31f';
$icon-file-pie-chart: '\e314';
$icon-file-play: '\e321';
$icon-file-plus-2: '\e0ca';
$icon-file-plus-corner: '\e0ca';
$icon-file-plus: '\e0c9';
$icon-file-question-mark: '\e322';
$icon-file-question: '\e322';
$icon-file-scan: '\e323';
$icon-file-search-2: '\e324';
$icon-file-search-corner: '\e324';
$icon-file-search: '\e0cb';
$icon-file-signal: '\e325';
$icon-file-signature: '\e320';
$icon-file-sliders: '\e5a0';
$icon-file-spreadsheet: '\e326';
$icon-file-stack: '\e4a1';
$icon-file-symlink: '\e327';
$icon-file-terminal: '\e328';
$icon-file-text: '\e0cc';
$icon-file-type-2: '\e36d';
$icon-file-type-corner: '\e36d';
$icon-file-type: '\e329';
$icon-file-up: '\e32a';
$icon-file-user: '\e62d';
$icon-file-video-2: '\e32b';
$icon-file-video-camera: '\e32b';
$icon-file-video: '\e321';
$icon-file-volume-2: '\e325';
$icon-file-volume: '\e32c';
$icon-file-warning: '\e319';
$icon-file-x-2: '\e0ce';
$icon-file-x-corner: '\e0ce';
$icon-file-x: '\e0cd';
$icon-file: '\e0c0';
$icon-files: '\e0cf';
$icon-film: '\e0d0';
$icon-filter-x: '\e3b5';
$icon-filter: '\e0dc';
$icon-fingerprint-pattern: '\e2cb';
$icon-fingerprint: '\e2cb';
$icon-fire-extinguisher: '\e57e';
$icon-fish-off: '\e3b0';
$icon-fish-symbol: '\e4f4';
$icon-fish: '\e3a6';
$icon-fishing-hook: '\e6af';
$icon-fishing-rod: '\e6b3';
$icon-flag-off: '\e292';
$icon-flag-triangle-left: '\e237';
$icon-flag-triangle-right: '\e238';
$icon-flag: '\e0d1';
$icon-flame-kindling: '\e53a';
$icon-flame: '\e0d2';
$icon-flashlight-off: '\e0d4';
$icon-flashlight: '\e0d3';
$icon-flask-conical-off: '\e396';
$icon-flask-conical: '\e0d5';
$icon-flask-round: '\e0d6';
$icon-flip-horizontal-2: '\e35e';
$icon-flip-horizontal: '\e35d';
$icon-flip-vertical-2: '\e360';
$icon-flip-vertical: '\e35f';
$icon-flower-2: '\e2d4';
$icon-flower: '\e2d3';
$icon-focus: '\e29e';
$icon-fold-horizontal: '\e43b';
$icon-fold-vertical: '\e43c';
$icon-folder-archive: '\e32d';
$icon-folder-check: '\e32e';
$icon-folder-clock: '\e32f';
$icon-folder-closed: '\e330';
$icon-folder-code: '\e5fb';
$icon-folder-cog-2: '\e331';
$icon-folder-cog: '\e331';
$icon-folder-dot: '\e4c5';
$icon-folder-down: '\e332';
$icon-folder-edit: '\e338';
$icon-folder-git-2: '\e40a';
$icon-folder-git: '\e409';
$icon-folder-heart: '\e333';
$icon-folder-input: '\e334';
$icon-folder-kanban: '\e4c6';
$icon-folder-key: '\e335';
$icon-folder-lock: '\e336';
$icon-folder-minus: '\e0d8';
$icon-folder-open-dot: '\e4c7';
$icon-folder-open: '\e247';
$icon-folder-output: '\e337';
$icon-folder-pen: '\e338';
$icon-folder-plus: '\e0d9';
$icon-folder-root: '\e4c8';
$icon-folder-search-2: '\e33a';
$icon-folder-search: '\e339';
$icon-folder-symlink: '\e33b';
$icon-folder-sync: '\e4c9';
$icon-folder-tree: '\e33c';
$icon-folder-up: '\e33d';
$icon-folder-x: '\e33e';
$icon-folder: '\e0d7';
$icon-folders: '\e33f';
$icon-footprints: '\e3b9';
$icon-fork-knife-crossed: '\e2f7';
$icon-fork-knife: '\e2f6';
$icon-forklift: '\e3c1';
$icon-form-input: '\e21f';
$icon-form: '\e6a8';
$icon-forward: '\e229';
$icon-frame: '\e291';
$icon-frown: '\e0db';
$icon-fuel: '\e2af';
$icon-fullscreen: '\e534';
$icon-function-square: '\e22d';
$icon-funnel-plus: '\e0dd';
$icon-funnel-x: '\e3b5';
$icon-funnel: '\e0dc';
$icon-gallery-horizontal-end: '\e4cf';
$icon-gallery-horizontal: '\e4ce';
$icon-gallery-thumbnails: '\e4d0';
$icon-gallery-vertical-end: '\e4d2';
$icon-gallery-vertical: '\e4d1';
$icon-gamepad-2: '\e0df';
$icon-gamepad-directional: '\e69b';
$icon-gamepad: '\e0de';
$icon-gantt-chart-square: '\e624';
$icon-gantt-chart: '\e4c4';
$icon-gauge-circle: '\e4e1';
$icon-gauge: '\e1bf';
$icon-gavel: '\e0e0';
$icon-gem: '\e242';
$icon-georgian-lari: '\e678';
$icon-ghost: '\e20e';
$icon-gift: '\e0e1';
$icon-git-branch-minus: '\e69c';
$icon-git-branch-plus: '\e1f4';
$icon-git-branch: '\e0e2';
$icon-git-commit-horizontal: '\e0e3';
$icon-git-commit-vertical: '\e552';
$icon-git-commit: '\e0e3';
$icon-git-compare-arrows: '\e553';
$icon-git-compare: '\e359';
$icon-git-fork: '\e28d';
$icon-git-graph: '\e554';
$icon-git-merge-conflict: '\e6b4';
$icon-git-merge: '\e0e4';
$icon-git-pull-request-arrow: '\e555';
$icon-git-pull-request-closed: '\e35a';
$icon-git-pull-request-create-arrow: '\e557';
$icon-git-pull-request-create: '\e556';
$icon-git-pull-request-draft: '\e35b';
$icon-git-pull-request: '\e0e5';
$icon-glass-water: '\e2d5';
$icon-glasses: '\e20d';
$icon-globe-2: '\e1f3';
$icon-globe-lock: '\e5cd';
$icon-globe-off: '\e6b5';
$icon-globe-x: '\e6b6';
$icon-globe: '\e0e8';
$icon-goal: '\e4a5';
...
$icon-grape: '\e352';
$icon-grid-2-x-2-check: '\e5e4';
$icon-grid-2-x-2-plus: '\e628';
$icon-grid-2-x-2-x: '\e5e5';
$icon-grid-2-x-2: '\e4ff';
$icon-grid-2x2-check: '\e5e4';
$icon-grid-2x2-plus: '\e628';
$icon-grid-2x2-x: '\e5e5';
$icon-grid-2x2: '\e4ff';
$icon-grid-3-x-3: '\e0e9';
$icon-grid-3x2: '\e66f';
$icon-grid-3x3: '\e0e9';
$icon-grid: '\e0e9';
$icon-grip-horizontal: '\e0ea';
$icon-grip-vertical: '\e0eb';
$icon-grip: '\e3b1';
$icon-group: '\e464';
$icon-guitar: '\e55f';
$icon-ham: '\e5d7';
$icon-hamburger: '\e665';
$icon-hammer: '\e0ec';
$icon-hand-coins: '\e5b8';
$icon-hand-fist: '\e68b';
$icon-hand-grab: '\e1e6';
$icon-hand-heart: '\e5b9';
$icon-hand-helping: '\e3b8';
$icon-hand-metal: '\e22c';
$icon-hand-platter: '\e5ba';
$icon-hand: '\e1d7';
$icon-handbag: '\e689';
$icon-handshake: '\e5c0';
$icon-hard-drive-download: '\e4e5';
$icon-hard-drive-upload: '\e4e6';
$icon-hard-drive: '\e0ed';
$icon-hard-hat: '\e0ee';
$icon-hash: '\e0ef';
$icon-hat-glasses: '\e683';
$icon-haze: '\e0f0';
$icon-hd: '\e6af';
$icon-hdmi-port: '\e4e7';
$icon-heading-1: '\e385';
...
$icon-heading-6: '\e38a';
$icon-heading: '\e384';
$icon-headphone-off: '\e629';
$icon-headphones: '\e0f1';
$icon-headset: '\e5bd';
$icon-heart-crack: '\e2d6';
$icon-heart-handshake: '\e2d7';
$icon-heart-minus: '\e651';
$icon-heart-off: '\e295';
$icon-heart-plus: '\e652';
$icon-heart-pulse: '\e36e';
$icon-heart: '\e0f2';
$icon-heater: '\e58e';
$icon-helicopter: '\e69d';
$icon-help-circle: '\e082';
$icon-helping-hand: '\e3b8';
$icon-hexagon: '\e0f3';
$icon-highlighter: '\e0f4';
$icon-history: '\e1f5';
$icon-home: '\e0f5';
$icon-hop-off: '\e398';
$icon-hop: '\e397';
...
$icon-hotel: '\e3e2';
$icon-hourglass: '\e296';
$icon-house-heart: '\e695';
$icon-house-plug: '\e5f0';
$icon-house-plus: '\e5f1';
$icon-house-wifi: '\e63c';
$icon-house: '\e0f5';
$icon-ice-cream-2: '\e3a7';
$icon-ice-cream-bowl: '\e3a7';
$icon-ice-cream-cone: '\e353';
$icon-ice-cream: '\e353';
$icon-id-card-lanyard: '\e670';
$icon-id-card: '\e617';
$icon-image-down: '\e53c';
$icon-image-minus: '\e1f6';
$icon-image-off: '\e1c0';
$icon-image-play: '\e5df';
$icon-image-plus: '\e1f7';
$icon-image-up: '\e5cb';
$icon-image-upscale: '\e637';
$icon-image: '\e0f6';
$icon-images: '\e5c4';
$icon-import: '\e22f';
$icon-inbox: '\e0f7';
$icon-indent-decrease: '\e107';
$icon-indent-increase: '\e108';
$icon-indent: '\e108';
$icon-indian-rupee: '\e0f8';
$icon-infinity: '\e1e7';
$icon-info: '\e0f9';
$icon-inspect: '\e202';
$icon-inspection-panel: '\e583';
$icon-italic: '\e0fb';
$icon-iteration-ccw: '\e423';
$icon-iteration-cw: '\e424';
$icon-japanese-yen: '\e0fc';
$icon-joystick: '\e355';
$icon-kanban-square-dashed: '\e16c';
$icon-kanban-square: '\e170';
$icon-kanban: '\e4dc';
$icon-kayak: '\e68f';
$icon-key-round: '\e4a3';
$icon-key-square: '\e4a4';
$icon-key: '\e0fd';
$icon-keyboard-music: '\e560';
$icon-keyboard-off: '\e5de';
$icon-keyboard: '\e284';
...
$icon-languages: '\e0fe';
$icon-laptop-2: '\e1d8';
$icon-laptop-minimal-check: '\e632';
...
$icon-layers-2: '\e52a';
$icon-layers-3: '\e529';
$icon-layers-plus: '\e6af';
$icon-layers: '\e529';
$icon-layout-dashboard: '\e1c1';
$icon-layout-grid: '\e0ff';
$icon-layout-list: '\e1d9';
$icon-layout-panel-left: '\e470';
$icon-layout-panel-top: '\e471';
$icon-layout-template: '\e207';
$icon-layout: '\e12c';
$icon-leaf: '\e2de';
$icon-leafy-green: '\e46f';
$icon-lectern: '\e5e9';
$icon-lens-concave: '\e6b7';
$icon-lens-convex: '\e6b8';
$icon-letter-text: '\e605';
$icon-library-big: '\e54e';
$icon-library-square: '\e54f';
$icon-library: '\e100';
$icon-life-buoy: '\e101';
$icon-ligature: '\e43a';
$icon-lightbulb-off: '\e208';
$icon-lightbulb: '\e1c2';
$icon-line-chart: '\e2a5';
$icon-line-dot-right-horizontal: '\e6b9';
$icon-line-squiggle: '\e67a';
$icon-line-style: '\e6da';
$icon-link-2-off: '\e104';
$icon-link-2: '\e103';
$icon-link: '\e102';
$icon-list-check: '\e5fa';
$icon-list-checks: '\e1d0';
$icon-list-chevrons-down-up: '\e694';
$icon-list-chevrons-up-down: '\e696';
$icon-list-collapse: '\e59b';
$icon-list-end: '\e2df';
$icon-list-filter-plus: '\e639';
$icon-list-filter: '\e460';
$icon-list-indent-decrease: '\e107';
$icon-list-indent-increase: '\e108';
$icon-list-minus: '\e23e';
$icon-list-music: '\e2e0';
$icon-list-ordered: '\e1d1';
$icon-list-plus: '\e23f';
$icon-list-restart: '\e452';
...
$icon-list: '\e106';
$icon-loader-2: '\e10a';
$icon-loader-circle: '\e10a';
$icon-loader-pinwheel: '\e5e6';
$icon-loader: '\e109';
$icon-locate-fixed: '\e1db';
$icon-locate-off: '\e282';
$icon-locate: '\e1da';
$icon-location-edit: '\e655';
$icon-lock-keyhole-open: '\e532';
$icon-lock-keyhole: '\e531';
$icon-lock-open: '\e10c';
$icon-lock: '\e10b';
$icon-log-in: '\e10d';
$icon-log-out: '\e10e';
...
$icon-m-square: '\e503';
$icon-magnet: '\e2b5';
$icon-mail-check: '\e361';
$icon-mail-minus: '\e362';
$icon-mail-open: '\e363';
$icon-mail-plus: '\e364';
$icon-mail-question-mark: '\e365';
$icon-mail-question: '\e365';
$icon-mail-search: '\e366';
$icon-mail-warning: '\e367';
$icon-mail-x: '\e368';
$icon-mail: '\e10f';
$icon-mailbox: '\e3d4';
$icon-mails: '\e369';
$icon-map-minus: '\e686';
$icon-map-pin-check-inside: '\e610';
$icon-map-pin-check: '\e60f';
$icon-map-pin-house: '\e61c';
$icon-map-pin-minus-inside: '\e612';
$icon-map-pin-minus: '\e611';
$icon-map-pin-off: '\e2a6';
$icon-map-pin-pen: '\e655';
$icon-map-pin-plus-inside: '\e614';
$icon-map-pin-plus: '\e613';
$icon-map-pin-x-inside: '\e616';
$icon-map-pin-x: '\e615';
$icon-map-pin: '\e111';
$icon-map-pinned: '\e53d';
$icon-map-plus: '\e63f';
$icon-map: '\e110';
$icon-mars-stroke: '\e642';
$icon-mars: '\e641';
$icon-martini: '\e2e3';
$icon-maximize-2: '\e113';
$icon-maximize: '\e112';
$icon-medal: '\e36f';
$icon-megaphone-off: '\e370';
$icon-megaphone: '\e235';
$icon-meh: '\e114';
$icon-memory-stick: '\e445';
$icon-menu-square: '\e453';
$icon-menu: '\e115';
$icon-merge: '\e43f';
$icon-message-circle-check: '\e6ba';
$icon-message-circle-code: '\e562';
$icon-message-circle-dashed: '\e563';
$icon-message-circle-heart: '\e564';
$icon-message-circle-more: '\e565';
$icon-message-circle-off: '\e566';
$icon-message-circle-plus: '\e567';
$icon-message-circle-question-mark: '\e568';
$icon-message-circle-question: '\e568';
$icon-message-circle-reply: '\e569';
$icon-message-circle-warning: '\e56a';
$icon-message-circle-x: '\e56b';
$icon-message-circle: '\e116';
$icon-message-square-check: '\e6bb';
$icon-message-square-code: '\e56c';
$icon-message-square-dashed: '\e40b';
$icon-message-square-diff: '\e56d';
$icon-message-square-dot: '\e56e';
$icon-message-square-heart: '\e56f';
$icon-message-square-lock: '\e62c';
$icon-message-square-more: '\e570';
$icon-message-square-off: '\e571';
$icon-message-square-plus: '\e40c';
$icon-message-square-quote: '\e572';
$icon-message-square-reply: '\e573';
$icon-message-square-share: '\e574';
$icon-message-square-text: '\e575';
$icon-message-square-warning: '\e576';
$icon-message-square-x: '\e577';
$icon-message-square: '\e117';
$icon-messages-square: '\e40d';
$icon-metronome: '\e6bc';
$icon-mic-2: '\e349';
$icon-mic-off: '\e119';
$icon-mic-vocal: '\e349';
...
$icon-milk-off: '\e39a';
$icon-milk: '\e399';
$icon-minimize-2: '\e11b';
$icon-minimize: '\e11a';
$icon-minus-circle: '\e07e';
$icon-minus-square: '\e171';
$icon-minus: '\e11c';
$icon-mirror-rectangular: '\e6bd';
$icon-mirror-round: '\e6be';
$icon-monitor-check: '\e482';
$icon-monitor-cloud: '\e699';
$icon-monitor-cog: '\e603';
$icon-monitor-dot: '\e483';
$icon-monitor-down: '\e421';
$icon-monitor-off: '\e1dc';
$icon-monitor-pause: '\e484';
$icon-monitor-play: '\e485';
$icon-monitor-smartphone: '\e3a2';
$icon-monitor-speaker: '\e210';
$icon-monitor-stop: '\e486';
$icon-monitor-up: '\e422';
$icon-monitor-x: '\e487';
$icon-monitor: '\e11d';
$icon-moon-star: '\e410';
$icon-moon: '\e11e';
$icon-more-horizontal: '\e0b6';
$icon-more-vertical: '\e0b7';
$icon-motorbike: '\e698';
$icon-mountain-snow: '\e232';
$icon-mountain: '\e231';
$icon-mouse-left: '\e6bf';
$icon-mouse-off: '\e5db';
$icon-mouse-pointer-2-off: '\e6a6';
$icon-mouse-pointer-2: '\e1c3';
$icon-mouse-pointer-ban: '\e5e7';
$icon-mouse-pointer-click: '\e120';
$icon-mouse-pointer-square-dashed: '\e509';
$icon-mouse-pointer: '\e11f';
$icon-mouse-right: '\e6c0';
$icon-mouse: '\e28e';
$icon-move-3-d: '\e2e5';
$icon-move-3d: '\e2e5';
$icon-move-diagonal-2: '\e1c5';
$icon-move-diagonal: '\e1c4';
$icon-move-down-left: '\e48d';
$icon-move-down-right: '\e48e';
$icon-move-down: '\e48c';
$icon-move-horizontal: '\e1c6';
$icon-move-left: '\e48f';
$icon-move-right: '\e490';
$icon-move-up-left: '\e492';
$icon-move-up-right: '\e493';
$icon-move-up: '\e491';
...
$icon-navigation-2: '\e124';
$icon-navigation-off: '\e2a8';
$icon-navigation: '\e123';
$icon-network: '\e125';
$icon-newspaper: '\e348';
$icon-nfc: '\e3c3';
$icon-non-binary: '\e643';
$icon-notebook-pen: '\e596';
$icon-notebook-tabs: '\e597';
$icon-notebook-text: '\e598';
$icon-notebook: '\e595';
$icon-notepad-text-dashed: '\e59a';
$icon-notepad-text: '\e599';
$icon-nut-off: '\e39c';
$icon-nut: '\e39b';
$icon-octagon-alert: '\e127';
$icon-octagon-minus: '\e627';
...
$icon-paint-roller: '\e59e';
$icon-paintbrush-2: '\e2e8';
$icon-paintbrush-vertical: '\e2e8';
$icon-paintbrush: '\e2e7';
$icon-palette: '\e1dd';
$icon-palmtree: '\e281';
$icon-panda: '\e668';
$icon-panel-bottom-close: '\e42d';
$icon-panel-bottom-dashed: '\e42e';
$icon-panel-bottom-inactive: '\e42e';
$icon-panel-bottom-open: '\e42f';
$icon-panel-bottom: '\e42c';
$icon-panel-left-close: '\e21c';
$icon-panel-left-dashed: '\e430';
$icon-panel-left-inactive: '\e430';
$icon-panel-left-open: '\e21d';
$icon-panel-left-right-dashed: '\e692';
$icon-panel-left: '\e12a';
$icon-panel-right-close: '\e432';
$icon-panel-right-dashed: '\e433';
$icon-panel-right-inactive: '\e433';
$icon-panel-right-open: '\e434';
$icon-panel-right: '\e431';
$icon-panel-top-bottom-dashed: '\e693';
$icon-panel-top-close: '\e436';
$icon-panel-top-dashed: '\e437';
$icon-panel-top-inactive: '\e437';
$icon-panel-top-open: '\e438';
$icon-panel-top: '\e435';
$icon-panels-left-bottom: '\e12b';
$icon-panels-left-right: '\e099';
$icon-panels-right-bottom: '\e588';
$icon-panels-top-bottom: '\e58a';
$icon-panels-top-left: '\e12c';
$icon-paperclip: '\e12d';
$icon-parentheses: '\e444';
$icon-parking-circle-off: '\e3ca';
$icon-parking-circle: '\e3c9';
$icon-parking-meter: '\e500';
$icon-parking-square-off: '\e3cc';
$icon-parking-square: '\e3cb';
$icon-party-popper: '\e343';
$icon-pause-circle: '\e07f';
$icon-pause-octagon: '\e21b';
$icon-pause: '\e12e';
$icon-paw-print: '\e4f5';
$icon-pc-case: '\e446';
$icon-pen-box: '\e172';
$icon-pen-line: '\e130';
$icon-pen-off: '\e5ee';
$icon-pen-square: '\e172';
$icon-pen-tool: '\e131';
$icon-pen: '\e12f';
$icon-pencil-line: '\e4f0';
$icon-pencil-off: '\e5ef';
$icon-pencil-ruler: '\e4f1';
$icon-pencil: '\e1f9';
$icon-pentagon: '\e52b';
$icon-percent-circle: '\e51a';
$icon-percent-diamond: '\e51b';
$icon-percent-square: '\e51c';
$icon-percent: '\e132';
$icon-person-standing: '\e21e';
$icon-philippine-peso: '\e604';
$icon-phone-call: '\e134';
$icon-phone-forwarded: '\e135';
$icon-phone-incoming: '\e136';
$icon-phone-missed: '\e137';
$icon-phone-off: '\e138';
$icon-phone-outgoing: '\e139';
$icon-phone: '\e133';
$icon-pi-square: '\e488';
$icon-pi: '\e472';
$icon-piano: '\e561';
$icon-pickaxe: '\e5c6';
$icon-picture-in-picture-2: '\e3af';
$icon-picture-in-picture: '\e3ae';
$icon-pie-chart: '\e06b';
$icon-piggy-bank: '\e13a';
$icon-pilcrow-left: '\e5dc';
$icon-pilcrow-right: '\e5dd';
$icon-pilcrow-square: '\e48b';
$icon-pilcrow: '\e3a3';
$icon-pill-bottle: '\e5ea';
$icon-pill: '\e3bd';
$icon-pin-off: '\e2b6';
$icon-pin: '\e259';
$icon-pipette: '\e13b';
$icon-pizza: '\e354';
$icon-plane-landing: '\e3cd';
$icon-plane-takeoff: '\e3ce';
$icon-plane: '\e1de';
$icon-play-circle: '\e080';
$icon-play-square: '\e481';
$icon-play: '\e13c';
$icon-plug-2: '\e380';
$icon-plug-zap-2: '\e45c';
$icon-plug-zap: '\e45c';
$icon-plug: '\e37f';
$icon-plus-circle: '\e081';
$icon-plus-square: '\e173';
$icon-plus: '\e13d';
$icon-pocket-knife: '\e4a0';
$icon-podcast: '\e1fa';
$icon-pointer-off: '\e57f';
$icon-pointer: '\e1e8';
$icon-popcorn: '\e4be';
$icon-popsicle: '\e4bf';
$icon-pound-sterling: '\e13f';
$icon-power-circle: '\e550';
$icon-power-off: '\e209';
$icon-power-square: '\e551';
$icon-power: '\e140';
$icon-presentation: '\e4ae';
$icon-printer-check: '\e5f5';
$icon-printer-x: '\e6c1';
$icon-printer: '\e141';
$icon-projector: '\e4af';
$icon-proportions: '\e5cf';
$icon-puzzle: '\e29c';
$icon-pyramid: '\e52c';
$icon-qr-code: '\e1df';
$icon-quote: '\e239';
...
$icon-radio-tower: '\e404';
$icon-radio: '\e142';
$icon-radius: '\e52d';
$icon-rainbow: '\e4c2';
$icon-rat: '\e3eb';
$icon-ratio: '\e4e8';
$icon-receipt-cent: '\e5a5';
$icon-receipt-euro: '\e5a6';
$icon-receipt-indian-rupee: '\e5a7';
$icon-receipt-japanese-yen: '\e5a8';
$icon-receipt-pound-sterling: '\e5a9';
$icon-receipt-russian-ruble: '\e5aa';
$icon-receipt-swiss-franc: '\e5ab';
$icon-receipt-text: '\e5ac';
$icon-receipt-turkish-lira: '\e67f';
$icon-receipt: '\e3d3';
$icon-rectangle-circle: '\e673';
$icon-rectangle-ellipsis: '\e21f';
$icon-rectangle-goggles: '\e656';
$icon-rectangle-horizontal: '\e376';
$icon-rectangle-vertical: '\e377';
$icon-recycle: '\e2e9';
$icon-redo-2: '\e2a0';
$icon-redo-dot: '\e450';
$icon-redo: '\e143';
$icon-refresh-ccw-dot: '\e4b2';
$icon-refresh-ccw: '\e144';
$icon-refresh-cw-off: '\e498';
$icon-refresh-cw: '\e145';
$icon-refrigerator: '\e37b';
$icon-regex: '\e1fc';
$icon-remove-formatting: '\e3b3';
$icon-repeat-1: '\e1fd';
$icon-repeat-2: '\e411';
$icon-repeat: '\e146';
$icon-replace-all: '\e3dc';
$icon-replace: '\e3db';
$icon-reply-all: '\e22b';
$icon-reply: '\e22a';
$icon-rewind: '\e147';
...
$icon-roller-coaster: '\e480';
$icon-rose: '\e691';
$icon-rotate-3-d: '\e2ea';
$icon-rotate-3d: '\e2ea';
$icon-rotate-ccw-key: '\e650';
$icon-rotate-ccw-square: '\e5d0';
$icon-rotate-ccw: '\e148';
$icon-rotate-cw-square: '\e5d1';
$icon-rotate-cw: '\e149';
$icon-route-off: '\e53f';
$icon-route: '\e53e';
$icon-router: '\e3bf';
...
$icon-rows: '\e439';
$icon-rss: '\e14a';
$icon-ruler-dimension-line: '\e662';
$icon-ruler: '\e14b';
$icon-russian-ruble: '\e14c';
$icon-sailboat: '\e37e';
$icon-salad: '\e3a8';
$icon-sandwich: '\e3a9';
$icon-satellite-dish: '\e448';
$icon-satellite: '\e447';
$icon-saudi-riyal: '\e64b';
$icon-save-all: '\e40f';
$icon-save-off: '\e5f3';
$icon-save: '\e14d';
$icon-scale-3-d: '\e2eb';
...
$icon-scale: '\e212';
$icon-scaling: '\e2ec';
$icon-scan-barcode: '\e535';
$icon-scan-eye: '\e536';
$icon-scan-face: '\e371';
$icon-scan-heart: '\e63a';
$icon-scan-line: '\e258';
$icon-scan-qr-code: '\e5f6';
$icon-scan-search: '\e537';
$icon-scan-text: '\e538';
$icon-scan: '\e257';
$icon-scatter-chart: '\e48a';
$icon-school-2: '\e3e5';
$icon-school: '\e3e3';
$icon-scissors-line-dashed: '\e4e9';
$icon-scissors-square-dashed-bottom: '\e4eb';
$icon-scissors-square: '\e4ec';
$icon-scissors: '\e14e';
$icon-scooter: '\e6ac';
$icon-screen-share-off: '\e150';
$icon-screen-share: '\e14f';
$icon-scroll-text: '\e45f';
$icon-scroll: '\e2ed';
$icon-search-alert: '\e6af';
$icon-search-check: '\e4aa';
$icon-search-code: '\e4ab';
$icon-search-slash: '\e4ac';
$icon-search-x: '\e4ad';
$icon-search: '\e151';
$icon-section: '\e5e8';
$icon-send-horizonal: '\e4f2';
$icon-send-horizontal: '\e4f2';
$icon-send-to-back: '\e4f3';
$icon-send: '\e152';
$icon-separator-horizontal: '\e1c8';
$icon-separator-vertical: '\e1c9';
$icon-server-cog: '\e341';
...
$icon-sheet: '\e157';
$icon-shell: '\e4f7';
$icon-shelving-unit: '\e6c2';
$icon-shield-alert: '\e1fe';
$icon-shield-ban: '\e159';
$icon-shield-check: '\e1ff';
$icon-shield-close: '\e200';
$icon-shield-cog-corner: '\e6da';
$icon-shield-cog: '\e6da';
$icon-shield-ellipsis: '\e516';
$icon-shield-half: '\e517';
$icon-shield-minus: '\e518';
$icon-shield-off: '\e15a';
$icon-shield-plus: '\e519';
$icon-shield-question-mark: '\e40e';
$icon-shield-question: '\e40e';
$icon-shield-user: '\e647';
$icon-shield-x: '\e200';
$icon-shield: '\e158';
$icon-ship-wheel: '\e502';
$icon-ship: '\e3ba';
$icon-shirt: '\e1ca';
$icon-shopping-bag: '\e15b';
$icon-shopping-basket: '\e4ea';
$icon-shopping-cart: '\e15c';
$icon-shovel: '\e15d';
$icon-shower-head: '\e37c';
$icon-shredder: '\e65b';
$icon-shrimp: '\e649';
$icon-shrink: '\e220';
$icon-shrub: '\e2ee';
$icon-shuffle: '\e15e';
$icon-sidebar-close: '\e21c';
$icon-sidebar-open: '\e21d';
$icon-sidebar: '\e12a';
$icon-sigma-square: '\e489';
$icon-sigma: '\e201';
...
$icon-signal: '\e25f';
$icon-signature: '\e5f2';
$icon-signpost-big: '\e541';
$icon-signpost: '\e540';
$icon-siren: '\e2ef';
$icon-skip-back: '\e15f';
$icon-skip-forward: '\e160';
$icon-skull: '\e221';
$icon-slash-square: '\e174';
$icon-slash: '\e51d';
$icon-slice: '\e2f0';
$icon-sliders-horizontal: '\e29a';
$icon-sliders-vertical: '\e162';
$icon-sliders: '\e162';
$icon-smartphone-charging: '\e22e';
$icon-smartphone-nfc: '\e3c4';
$icon-smartphone: '\e163';
$icon-smile-plus: '\e301';
$icon-smile: '\e164';
$icon-snail: '\e4f8';
$icon-snowflake: '\e165';
$icon-soap-dispenser-droplet: '\e669';
$icon-sofa: '\e2c4';
$icon-solar-panel: '\e69f';
$icon-sort-asc: '\e04c';
$icon-sort-desc: '\e047';
$icon-soup: '\e3aa';
$icon-space: '\e3dd';
...
$icon-speaker: '\e166';
$icon-speech: '\e51e';
$icon-spell-check-2: '\e49b';
$icon-spell-check: '\e49a';
$icon-spline-pointer: '\e64f';
$icon-spline: '\e38b';
$icon-split-square-horizontal: '\e3b6';
$icon-split-square-vertical: '\e3b7';
$icon-split: '\e440';
$icon-spool: '\e677';
$icon-sport-shoe: '\e6db';
$icon-spotlight: '\e682';
$icon-spray-can: '\e495';
$icon-sprout: '\e1eb';
$icon-square-activity: '\e4b4';
$icon-square-arrow-down-left: '\e4b5';
$icon-square-arrow-down-right: '\e4b6';
$icon-square-arrow-down: '\e427';
$icon-square-arrow-left: '\e428';
$icon-square-arrow-out-down-left: '\e5a1';
$icon-square-arrow-out-down-right: '\e5a2';
$icon-square-arrow-out-up-left: '\e5a3';
$icon-square-arrow-out-up-right: '\e5a4';
$icon-square-arrow-right-enter: '\e6c3';
$icon-square-arrow-right-exit: '\e6c4';
$icon-square-arrow-right: '\e429';
$icon-square-arrow-up-left: '\e4b7';
$icon-square-arrow-up-right: '\e4b8';
$icon-square-arrow-up: '\e42a';
$icon-square-asterisk: '\e168';
$icon-square-bottom-dashed-scissors: '\e4eb';
$icon-square-centerline-dashed-horizontal: '\e6c5';
$icon-square-centerline-dashed-vertical: '\e6c6';
$icon-square-chart-gantt: '\e169';
$icon-square-check-big: '\e16a';
$icon-square-check: '\e559';
$icon-square-chevron-down: '\e3cf';
$icon-square-chevron-left: '\e3d0';
$icon-square-chevron-right: '\e3d1';
$icon-square-chevron-up: '\e3d2';
$icon-square-code: '\e16b';
$icon-square-dashed-bottom-code: '\e4c1';
$icon-square-dashed-bottom: '\e4c0';
$icon-square-dashed-kanban: '\e16c';
$icon-square-dashed-mouse-pointer: '\e509';
$icon-square-dashed-top-solid: '\e66c';
$icon-square-dashed: '\e1cb';
$icon-square-divide: '\e16d';
$icon-square-dot: '\e16e';
$icon-square-equal: '\e16f';
$icon-square-function: '\e22d';
$icon-square-gantt-chart: '\e169';
$icon-square-kanban: '\e170';
$icon-square-library: '\e54f';
$icon-square-m: '\e503';
$icon-square-menu: '\e453';
$icon-square-minus: '\e171';
$icon-square-mouse-pointer: '\e202';
$icon-square-parking-off: '\e3cc';
$icon-square-parking: '\e3cb';
$icon-square-pause: '\e684';
$icon-square-pen: '\e172';
$icon-square-percent: '\e51c';
$icon-square-pi: '\e488';
$icon-square-pilcrow: '\e48b';
$icon-square-play: '\e481';
$icon-square-plus: '\e173';
$icon-square-power: '\e551';
$icon-square-radical: '\e5c3';
$icon-square-round-corner: '\e648';
$icon-square-scissors: '\e4ec';
$icon-square-sigma: '\e489';
$icon-square-slash: '\e174';
$icon-square-split-horizontal: '\e3b6';
$icon-square-split-vertical: '\e3b7';
$icon-square-square: '\e60e';
$icon-square-stack: '\e4a2';
$icon-square-star: '\e68e';
$icon-square-stop: '\e685';
$icon-square-terminal: '\e20a';
$icon-square-user-round: '\e466';
$icon-square-user: '\e465';
$icon-square-x: '\e175';
$icon-square: '\e167';
$icon-squares-exclude: '\e657';
$icon-squares-intersect: '\e658';
$icon-squares-subtract: '\e659';
$icon-squares-unite: '\e65a';
$icon-squircle-dashed: '\e679';
$icon-squircle: '\e57a';
$icon-squirrel: '\e49f';
$icon-stamp: '\e3bb';
$icon-star-half: '\e20b';
...
$icon-swatch-book: '\e59f';
$icon-swiss-franc: '\e17b';
$icon-switch-camera: '\e17c';
$icon-sword: '\e2b3';
$icon-swords: '\e2b4';
$icon-syringe: '\e2f2';
$icon-table-2: '\e2f9';
$icon-table-cells-merge: '\e5c7';
$icon-table-cells-split: '\e5c8';
$icon-table-columns-split: '\e5c9';
$icon-table-config: '\e661';
$icon-table-of-contents: '\e61e';
$icon-table-properties: '\e4db';
$icon-table-rows-split: '\e5ca';
$icon-table: '\e17d';
$icon-tablet-smartphone: '\e50a';
$icon-tablet: '\e17e';
$icon-tablets: '\e3be';
$icon-tag: '\e17f';
$icon-tags: '\e35c';
...
$icon-tent-tree: '\e53b';
$icon-tent: '\e227';
$icon-terminal-square: '\e20a';
$icon-terminal: '\e181';
$icon-test-tube-2: '\e406';
$icon-test-tube-diagonal: '\e406';
$icon-test-tube: '\e405';
$icon-test-tubes: '\e407';
$icon-text-align-center: '\e182';
$icon-text-align-end: '\e183';
$icon-text-align-justify: '\e184';
$icon-text-align-start: '\e185';
$icon-text-cursor-input: '\e265';
$icon-text-cursor: '\e264';
$icon-text-initial: '\e605';
$icon-text-quote: '\e49e';
$icon-text-search: '\e5ad';
$icon-text-select: '\e3de';
$icon-text-selection: '\e3de';
$icon-text-wrap: '\e248';
$icon-text: '\e185';
$icon-theater: '\e522';
...
$icon-thumbs-up: '\e18a';
$icon-ticket-check: '\e5ae';
$icon-ticket-minus: '\e5af';
$icon-ticket-percent: '\e5b0';
$icon-ticket-plus: '\e5b1';
$icon-ticket-slash: '\e5b2';
$icon-ticket-x: '\e5b3';
$icon-ticket: '\e20f';
$icon-tickets-plane: '\e623';
$icon-tickets: '\e622';
$icon-timer-off: '\e249';
...
$icon-tornado: '\e218';
$icon-torus: '\e52f';
$icon-touchpad-off: '\e44a';
$icon-touchpad: '\e449';
$icon-towel-rack: '\e6c7';
$icon-tower-control: '\e3bc';
$icon-toy-brick: '\e347';
$icon-tractor: '\e504';
$icon-traffic-cone: '\e505';
$icon-train-front-tunnel: '\e507';
$icon-train-front: '\e506';
$icon-train-track: '\e508';
$icon-train: '\e2a9';
$icon-tram-front: '\e2a9';
$icon-transgender: '\e644';
$icon-trash-2: '\e18e';
$icon-trash: '\e18d';
...
$icon-trending-up-down: '\e625';
$icon-trending-up: '\e191';
$icon-triangle-alert: '\e193';
$icon-triangle-dashed: '\e63d';
$icon-triangle-right: '\e4ed';
$icon-triangle: '\e192';
$icon-trophy: '\e373';
$icon-truck-electric: '\e65f';
$icon-truck: '\e194';
$icon-turkish-lira: '\e680';
$icon-turntable: '\e68c';
$icon-turtle: '\e4f9';
$icon-tv-2: '\e203';
$icon-tv-minimal-play: '\e5ec';
$icon-tv-minimal: '\e203';
$icon-tv: '\e195';
$icon-type-outline: '\e602';
$icon-type: '\e198';
$icon-umbrella-off: '\e543';
$icon-umbrella: '\e199';
$icon-underline: '\e19a';
$icon-undo-2: '\e2a1';
$icon-undo-dot: '\e451';
$icon-undo: '\e19b';
$icon-unfold-horizontal: '\e43d';
$icon-unfold-vertical: '\e43e';
$icon-ungroup: '\e467';
$icon-university: '\e3e5';
$icon-unlink-2: '\e19d';
$icon-unlink: '\e19c';
$icon-unlock-keyhole: '\e532';
$icon-unlock: '\e10c';
$icon-unplug: '\e45d';
$icon-upload-cloud: '\e091';
$icon-upload: '\e19e';
$icon-usb: '\e356';
$icon-user-2: '\e468';
$icon-user-check-2: '\e469';
$icon-user-check: '\e1a0';
$icon-user-circle-2: '\e462';
$icon-user-circle: '\e461';
$icon-user-cog-2: '\e46a';
$icon-user-cog: '\e342';
$icon-user-key: '\e6c8';
$icon-user-lock: '\e660';
$icon-user-minus-2: '\e46b';
$icon-user-minus: '\e1a1';
$icon-user-pen: '\e5fc';
$icon-user-plus-2: '\e46c';
$icon-user-plus: '\e1a2';
$icon-user-round-check: '\e469';
$icon-user-round-cog: '\e46a';
$icon-user-round-key: '\e6c9';
$icon-user-round-minus: '\e46b';
$icon-user-round-pen: '\e5fd';
$icon-user-round-plus: '\e46c';
$icon-user-round-search: '\e578';
$icon-user-round-x: '\e46d';
$icon-user-round: '\e468';
$icon-user-search: '\e579';
$icon-user-square-2: '\e466';
$icon-user-square: '\e465';
$icon-user-star: '\e687';
$icon-user-x-2: '\e46d';
$icon-user-x: '\e1a3';
$icon-user: '\e19f';
$icon-users-2: '\e46e';
$icon-users-round: '\e46e';
$icon-users: '\e1a4';
$icon-utensils-crossed: '\e2f7';
$icon-utensils: '\e2f6';
$icon-utility-pole: '\e3c2';
$icon-van: '\e6ad';
$icon-variable: '\e473';
$icon-vault: '\e58f';
$icon-vector-square: '\e67c';
$icon-vegan: '\e39d';
$icon-venetian-mask: '\e2aa';
$icon-venus-and-mars: '\e646';
$icon-venus: '\e645';
$icon-verified: '\e241';
...
$icon-view: '\e1a7';
$icon-voicemail: '\e1a8';
$icon-volleyball: '\e62f';
$icon-volume-1: '\e1aa';
$icon-volume-2: '\e1ab';
$icon-volume-off: '\e626';
$icon-volume-x: '\e1ac';
$icon-volume: '\e1a9';
$icon-vote: '\e3ad';
$icon-wallet-2: '\e4cd';
$icon-wallet-cards: '\e4cc';
$icon-wallet-minimal: '\e4cd';
$icon-wallet: '\e204';
$icon-wallpaper: '\e44b';
$icon-wand-2: '\e357';
$icon-wand-sparkles: '\e357';
$icon-wand: '\e246';
$icon-warehouse: '\e3e6';
$icon-washing-machine: '\e590';
$icon-watch: '\e1ad';
$icon-waves-arrow-down: '\e6a9';
$icon-waves-arrow-up: '\e6aa';
$icon-waves-ladder: '\e63b';
$icon-waves: '\e283';
$icon-waypoints: '\e542';
$icon-webcam: '\e205';
$icon-webhook-off: '\e5b7';
$icon-webhook: '\e374';
$icon-weight-tilde: '\e6ae';
$icon-weight: '\e530';
$icon-wheat-off: '\e39f';
$icon-wheat: '\e39e';
$icon-whole-word: '\e3df';
$icon-wifi-cog: '\e674';
$icon-wifi-high: '\e5f7';
$icon-wifi-low: '\e5f8';
$icon-wifi-off: '\e1af';
...
$icon-wrench: '\e1b1';
$icon-x-circle: '\e084';
$icon-x-line-top: '\e6ca';
$icon-x-octagon: '\e128';
$icon-x-square: '\e175';
$icon-x: '\e1b2';
$icon-zap-off: '\e1b5';
$icon-zap: '\e1b4';
$icon-zodiac-aquarius: '\e6cb';
$icon-zodiac-aries: '\e6cc';
$icon-zodiac-cancer: '\e6cd';
$icon-zodiac-capricorn: '\e6ce';
$icon-zodiac-gemini: '\e6cf';
$icon-zodiac-leo: '\e6d0';
$icon-zodiac-libra: '\e6d1';
$icon-zodiac-ophiuchus: '\e6d2';
$icon-zodiac-pisces: '\e6d3';
$icon-zodiac-sagittarius: '\e6d4';
$icon-zodiac-scorpio: '\e6d5';
$icon-zodiac-taurus: '\e6d6';
$icon-zodiac-virgo: '\e6d7';
$icon-zoom-in: '\e1b6';
$icon-zoom-out: '\e1b7';
